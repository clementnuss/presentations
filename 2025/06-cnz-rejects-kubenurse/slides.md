...
layout: cover
title: "Quantifying Randomness On Your Clusters With `kubenurse`"
...
mdc: true
hideInToc: true
exportFilename: quantifying-randomness-kubenurse
---

## Quantifying Randomness With

# kubenurse

Cloud Native Zürich Rejects - June 3rd 2025

**Clément Nussbaumer**

<a href="https://clement.n8r.ch/en/articles/" style="font-size: 1.5rem;" target="_blank" alt="Blog" class="absolute right-8rem bottom-30px m-6 text-xl">clement.n8r.ch</a>

<img src="./images/Jura.png" alt="jura flag" width="20rem" class="absolute right-6rem bottom-30px m-6 text-xl">
...
> register.
> <cite style="font-size: 70%;line-height: 1rem;display:block">Algorithms and
  > Theory of Computation Handbook, CRC Press LLC, 1999, "random access
> machine", in Dictionary of Algorithms and Data Structures , Paul E. Black,
> ed. 17 December 2004. Source:
  <a href="https://www.nist.gov/dads/HTML/randomaccess.html"
  > target="_blank">www.nist.gov/dads/HTML/randomaccess.html</a></cite>
...
> <cite style="font-size: 70%;line-height: 1rem;display:block">Clément Nussbaumer, 2025 (and the list keeps getting longer)</cite>
...
<div place-items="center" class="flex justify-center col-span-2" style="text-align: center;">
...
<img border="rounded" src="/images/kubenurse-star-history-202506.png" alt="">
</div>
</div>
